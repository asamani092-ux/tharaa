...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      [
        ...
        "focus-visible:outline-none focus-visible:border-[var(--primary-600)]",
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 text-[var(--text-secondary)] opacity-80" />
    ...
    <SelectPrimitive.Content
      ...
      className={cn(
        [
          ...
          "bg-[var(--bg-primary)] text-[var(--text-primary)] shadow-[var(--shadow-lg)]",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("px-2 py-1.5 text-[var(--font-sm)] font-semibold text-[var(--text-secondary)]", className)}
    {...props}
  />
))
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      [
        ...
        "py-2 pr-8 pl-2 text-[var(--font-sm)] outline-none",
        "focus:bg-[var(--primary-50)] focus:text-[var(--primary-600)]",
